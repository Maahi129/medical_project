...
def test_get_patient_name(doc_1_kathy,doc_2_Navya):
    assert doc_1_kathy.get_patient_name() == 'Kathy Crawford'
    assert doc_2_Navya.get_patient_name() == 'Navya Pellakuru'


def test_get_patient_phone_number(doc_1_kathy, doc_2_Navya):
    assert doc_1_kathy.get_patient_phone_number() == '(737) 988-0851'
    assert doc_2_Navya.get_patient_phone_number() == '(279) 920-8204'


def test_get_hepatitis_b_vaccination(doc_1_kathy, doc_2_Navya):
    assert doc_1_kathy.get_hepatitis_b_vaccination() == 'No'
    assert doc_2_Navya.get_hepatitis_b_vaccination() == 'Yes'


def test_get_medical_problems(doc_1_kathy, doc_2_Navya):
    assert doc_1_kathy.get_medical_problems() == 'Migraine'
    assert doc_2_Navya.get_medical_problems() == 'N/A'

def test_parse(doc_1_kathy, doc_2_Navya):
